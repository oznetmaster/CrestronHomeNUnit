# Crestron Home NUnit user and developer guide
...
The supplied NUnit self-test host disables optimization in both Debug and Release so the merged assembly retains stack frames required by upstream stack-trace assertions. Generic processor test packages keep their normal optimization settings.
